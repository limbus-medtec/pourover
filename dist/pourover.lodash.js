  ...
  var PourOver = (function() {
    ...
    PourOver = {
      ...
      buildPermutationArray: function(set, sort) {
        ...
        _(sorted_set).forEach(function(m, i) {
          perm[m.cid] = i;
        });
        return perm;
      },
    ...
    _.extend(PourOver.Collection.prototype, PourOver.Events, {
      ...
      // efficient way of removing all items from the collection
      removeAllItems: function() {
        var old_items = this.items;
        this.items = [];
        this.regenerateFilterSets();
        this.trigger("change", _(old_items).map("cid"));
      },
      ...
      removeItems: function(toRemove, isSorted) {
        ...
        if (isSorted) {
          toRemove = _(toRemove).sortBy(function(elem1, elem2) {
            return elem1.cid - elem2.cid;
          });
          var new_items = [];
          var old_items = this.items;
          var new_length = toRemove.length;
